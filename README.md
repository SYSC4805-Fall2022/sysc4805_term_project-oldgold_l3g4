...
### The [lineDetector.cpp] (https://github.com/SYSC4805-Fall2022/sysc4805_term_project-oldgold_l3g4/blob/ca081ecd65f376da9b269ba511171101433c0726/projectCode/lineDetector.cpp)

This script is used to detect the black path line and makes use of the Line follower
sensor.  

### The [motorControl.cpp] (https://github.com/SYSC4805-Fall2022/sysc4805_term_project-oldgold_l3g4/blob/ca081ecd65f376da9b269ba511171101433c0726/projectCode/motorControl.cpp)

This script is used to control the motor and allow the assembly to move in any direction
```Forward```,  ```Backward```,  ```Left``` and ```Right```. 

### The [projectCode.ino] (https://github.com/SYSC4805-Fall2022/sysc4805_term_project-oldgold_l3g4/blob/ca081ecd65f376da9b269ba511171101433c0726/projectCode/projectCode.ino)
